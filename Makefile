#############################################################################
# Makefile for building: PathExplorationQt4
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Mar 14 08:41:06 2014
# Project:  PathExplorationQt4.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile PathExplorationQt4.pro
#############################################################################
...
SOURCES       = findpath.cc \
		qt4display.cc moc_qt4display.cpp
OBJECTS       = findpath.o \
		qt4display.o \
		moc_qt4display.o
DIST          = /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		...
		PathExplorationQt4.pro
QMAKE_TARGET  = PathExplorationQt4
DESTDIR       = 
TARGET        = PathExplorationQt4
...
Makefile: PathExplorationQt4.pro  /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile PathExplorationQt4.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/PathExplorationQt41.0.0 || $(MKDIR) .tmp/PathExplorationQt41.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PathExplorationQt41.0.0/ && $(COPY_FILE) --parents qt4display.h PointClass/Point2.h PointClass/Point3.h PointClass/Point2.cc PointClass/Point3.cc .tmp/PathExplorationQt41.0.0/ && $(COPY_FILE) --parents findpath.cc qt4display.cc .tmp/PathExplorationQt41.0.0/ && (cd `dirname .tmp/PathExplorationQt41.0.0` && $(TAR) PathExplorationQt41.0.0.tar PathExplorationQt41.0.0 && $(COMPRESS) PathExplorationQt41.0.0.tar) && $(MOVE) `dirname .tmp/PathExplorationQt41.0.0`/PathExplorationQt41.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PathExplorationQt41.0.0
...
compiler_moc_header_make_all: moc_qt4display.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qt4display.cpp
moc_qt4display.cpp: qt4display.h
	/usr/local/Cellar/qt/4.8.5/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ qt4display.h -o moc_qt4display.cpp
...
findpath.o: findpath.cc qt4display.h \
		PointClass/Point2.cc \
		PointClass/Point2.h \
		PointClass/Point3.cc \
		PointClass/Point3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o findpath.o findpath.cc

qt4display.o: qt4display.cc qt4display.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qt4display.o qt4display.cc

moc_qt4display.o: moc_qt4display.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qt4display.o moc_qt4display.cpp
